...
import (
	...
	"github.com/nextphoton/notification-service/config"
...
func main() {
	...
	notifService := service.NewNotificationService(database)
	_ = notifService
	...
	go func() {
		log.Printf("Notification service ready at http://localhost:%s", cfg.ServerPort)
