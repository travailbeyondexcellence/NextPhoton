...
import (
	...
	"github.com/nextphoton/analytics-service/config"
...
func main() {
	...
	log.Printf("Starting Analytics Service on port %s", cfg.ServerPort)
	...
	go func() {
		log.Printf("Analytics service ready at http://localhost:%s", cfg.ServerPort)
