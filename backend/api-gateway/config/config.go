...
func Load() *Config {
	return &Config{
		Server: ServerConfig{
			...
			Port:            getEnvInt("SERVER_PORT", 3960),
		...
		Services: ServicesConfig{
			...
			UserServiceURL:         getEnv("USER_SERVICE_URL", "http://localhost:3964"),
			SessionServiceURL:      getEnv("SESSION_SERVICE_URL", "http://localhost:3965"),
			CurriculumServiceURL:   getEnv("CURRICULUM_SERVICE_URL", "http://localhost:3961"),
			NotificationServiceURL: getEnv("NOTIFICATION_SERVICE_URL", "http://localhost:3966"),
			PaymentServiceURL:      getEnv("PAYMENT_SERVICE_URL", "http://localhost:3967"),
			AnalyticsServiceURL:    getEnv("ANALYTICS_SERVICE_URL", "http://localhost:3969"),
			MediaServiceURL:        getEnv("MEDIA_SERVICE_URL", "http://localhost:3968"),
