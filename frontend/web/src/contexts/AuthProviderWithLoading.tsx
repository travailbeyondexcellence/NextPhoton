/**
 * AuthProvider with Loading Integration
 *
 * This wrapper ensures AuthProvider can use the LoadingContext
 * by being a child of LoadingProvider.
 */
...
/**
 * Inner Authentication Provider Component
 * This component can safely use useLoading since it's wrapped by LoadingProvider
 */
export function AuthProviderInner({ children }: { children: React.ReactNode }) {
  ...
  /**
   * Register function with loading state
   */
