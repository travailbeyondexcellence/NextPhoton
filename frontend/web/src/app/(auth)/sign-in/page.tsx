        ...
        <div className="bg-white/10 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="flex-1 py-2.5 px-4 bg-muted/50 hover:bg-muted/70 border border-input rounded-xl transition-all flex items-center justify-center gap-2 group text-sm font-medium"
                onClick={() => {/* TODO: Implement Facebook login */}}
              >
                <svg className="w-4 h-4 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
                <span className="text-foreground">Login with Facebook</span>
              </button>
              <button
                type="button"
                className="flex-1 py-2.5 px-4 bg-muted/50 hover:bg-muted/70 border border-input rounded-xl transition-all flex items-center justify-center gap-2 group text-sm font-medium"
