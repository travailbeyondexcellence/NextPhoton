...
const AssignmentListPage = async ({
  ...
  const renderRow = (item: AssignmentList) => (
    ...
    >
      <td className="flex items-center gap-4 p-4 text-gray-900 dark:text-gray-100">{item.lesson.subject.name}</td>
      <td className="text-gray-700 dark:text-gray-300">{item.lesson.class.name}</td>
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-4 rounded-md flex-1 min-h-0 min-w-0 m-4 transition-colors duration-200">
      {/* TOP */}
